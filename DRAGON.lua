...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,0, 1, nil, './'..bot_id..'.json', '- عدد مجموعهات التي في البوت { '..#list..'}')
end
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'♫︙ اصدار سورس باكي \n♫︙ الاصدار »{ v 1.6 }')
end
...
-------------
if text == "مـبـرمــج الـسورس" and DevSoFi(msg) then  
local updatech =[[
مـبـرمـج السـورس
]]
keyboard = {} 
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'♫︙ لا يوجد مجموعهات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
send(msg.chat_id_, msg.id_,"♫︙ تمت الاذاعه الى >>{"..#list.."} مجموعهات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
-----------------------------------------------------
if text == 'مسح المرفوعين' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ♫ تـم تنزيل جميع المفشوخين بنجاح 😂🌝')
end
if text == ("تاك للمرفوعين") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n ♫ قائمه المرفوعين 🥺😂 \n⩹━━━━━━ التاك دا مش بتاع السورس 😂 دا برعاية جامبول  ━━━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."♫ المفشوخ [@"..username.."]\n"
else
t = t..""..k.."♫ المفشوخ `"..v.."`\n"
end
end
...
if (text == ("تنزيل")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n♫︙  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceBaki')..')'
status  = '\n♫︙  الايدي » `'..result.sender_user_id_..'`\n♫︙  تم تنزيله ادمن من المجموعه بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = SUDO},function(arg,result) 
 ...
 local msg_id = msg.id_/2097152/0.5
local Text = [[
مطــور الـبوت للتــواصـل  معـاه
]]
keyboard = {} 
...
send(msg.chat_id_, msg.id_,'♫︙لقـب اي يسطا انتا محدش عارفك اصلا 😂 ') 
else
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'باكي').." غادر" or text == 'بوت غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,'♫︙ اوك باي') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
if text == "بوت" or text == 'البوت' or text == 'يا بوت' then
...
if result.id_ then
send(msg.chat_id_, msg.id_,'♫︙ تعال حبي يصيحونك بل مجموعه [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
if text == 'تيست' and Manager(msg) then
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙱𝙰𝙺𝙸', url="t.me/SourceBaki"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_,msg.id_, '[انـت عضو قمـيل 🥺❤️](t.me/SourceBaki)') 
return false
end
...
if text == 'العاب باكي ' or text == 'الالعاب المتطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '♫قنـآة السـورس ♫', url="https://t.me/SourceBaki"},{text = '♫مــبـرمج السورس ♫', url="https://t.me/Baki_Owner"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AddBaki/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
