...
print([[
 ...
 -----------------------------------------------------------------------------------
 -----------------------------------------------------------------------------------
  -BBBBBBBBBBBB- /////// -AAAAAAAA- /////// -KK         KK- // -IIIIIIIIIIIIIIII-
  -BB         BB- ////// -AA    AA- /////// -KK        KK- ///////// -IIII-
  -BB          BB- ///// -AA    AA- /////// -KK       KK-  ///////// -IIII-
  -BB           BB- //// -AA    AA- /////// -KK      KK- /////////// -IIII-
  -BB          BB- ///// -AA    AA- /////// -KK     KK- //////////// -IIII-
  -BB         BB- ////// -AA    AA- /////// -KK    KK- ///////////// -IIII-
  -BB        BB- /////// -AA    AA- /////// -KK   KK- ////////////// -IIII-
  -BB       BB-  /////// -AA    AA- /////// -KK  KK- /////////////// -IIII-
  -bbbbbbbbb-    /////// -AA    AA- /////// -KK KK- //////////////// -IIII-
  -BB       BB-  /////// -aaaaaaaa- /////// -kkkk- ///////////////// -IIII-
  -BB        BB-  ///// -AA      AA- ////// -KK KK- //////////////// -IIII-
  -BB         BB- //// -AA        AA- ///// -KK  KK- /////////////// -IIII-
  -BB          BB- // -AA          AA- //// -KK   KK- ////////////// -IIII-
  -BB         BB- // -AA            AA- /// -KK    KK- ///////////// -IIII-
  -BB        BB- // -AA              AA- // -KK     KK- //////////// -IIII-
  -BB       BB- // -AA                AA- / -KK      KK- /////////// -IIII-
  -BBBBBBBBBB- // -AA                  AA-/ -KK       KK- //// -IIIIIIIIIIIIIIII-
  -----------------------------------------------------------------------------------
  -----------------------------------------------------------------------------------


> CH › @SourceBaki
~> DEVELOPER › @Baki_Owner 
]])
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'باكي'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ❲☆ 𝐵𝐴𝐾𝐼 ☆❳")  
...
local SourceBaki = database:get(bot_id..'text:ch:user')
if SourceBaki then
send(msg.chat_id_, msg.id_,'['..SourceBaki..']')
else
...
send(msg.chat_id_, msg.id_,' ♫  اصدار سورس باكي { s: 6.7}')
end
if text == 'بقدونس مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV BAKI](t.me/Baki_Owner)
]] 
keyboard = {}  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' ♫  ⁽قناه السورس️️₎ ♫ ', url="t.me/SourceBaki"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
{{text = 'اضف البوت الي مجموعتك ' ,url="t.me/"..dofile("./vvvvvvInfo.lua").botUserName.."?startgroup=start"}}, 
} 
...
usertext = '\n ♫  العضو ← ['..result.title_..'](t.me/'..(username or 'SourceBaki')..')'
status  = '\n ♫  تم ترقيته مطور'
...
usertext = '\n ♫  العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceBaki')..')'
status  = '\n ♫  تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♫  العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceBaki')..') \n ♫  '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ♫  العضو : {["..data.first_name_.."](T.ME/SourceBaki)}\n ♫  ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Ahmed-Baki/BAKI/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Ahmed-Baki/BAKI/main/library')
os.execute('wget https://raw.githubusercontent.com/Ahmed-Baki/BAKI/main/File_Bot')
send(msg.chat_id_, msg.id_,' ♫  تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
if text == '♫ ━━━❲☆ 𝐵𝐴𝐾𝐼 ☆❳━━━♫ ' then
local Text = [[ 
♫ من أحسن السورسات على التليجرام سورس باكي♫ 
 سورس أمان جدا وفي مميزات جامده
تع نصب بوتك عندنا لو محظور
خش على تواصل هيدخلك لبوت التواصل 
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '   ⁽SＯＵＲＣＥ₎ ', url="t.me/SourceBaki"}}, 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ♫  بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceBaki')..') \n ♫  تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♫  بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SourceBaki')..') \n ♫  تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n♫ تم قفل البوتات بالطرد\n♫ تم وضع الايدي بدون صوره\n♫ تم قفل التكرار بالطرد\n♫ تم قفل الروابط\n♫ تم قفل التوجيه\n♫ تم قفل الملصقات\n♫ تم قفل المتحركه\n♫ تم قفل الفيديو\n♫ تم قفل السب\n♫ تم قفل التعديل\n♫ تم قفل الفارسيه\n♫ تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceBaki')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ♫  لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceBaki')..')'
status  = '\n ♫  تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ♫  العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♫  العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceBaki')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ♫  العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'SourceBaki')..')'..'\n ♫  تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 30000 then 
send(msg.chat_id_, msg.id_,'♫ تستطيع التنظيف 30000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
database:set(bot_id.."SourceBaki:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."SourceBaki:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SourceBaki:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SourceBaki:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"♫ تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SourceBaki:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SourceBaki:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/SourceBaki)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/SourceBaki)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/SourceBaki)')
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceBaki')..')'
local iduser = result.sender_user_id_
...
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚅𝙸𝚁𝙰', url="t.me/SourceBaki"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
